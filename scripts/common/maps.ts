 ...
 * cache. Currently just `tier`, which the website deliberately doesn't return (it's
 * only needed by the front end, and Leaderboard.tier is null for submission maps).
 */
